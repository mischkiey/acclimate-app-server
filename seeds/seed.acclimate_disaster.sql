...
VALUES
    ...
    ('Wildfire', 'Natural', 'A wildfire can spread quickly across forests and fields, giving you little time to evacuate to safety. Drought, dry conditions, and the careless use of fire all contribute to increased risk of wildfire. Get the facts about wildfires and learn what to do to keep your loved ones safe! (Taken from redcross.org)', 'https://images.unsplash.com/photo-1572204097183-e1ab140342ed?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2250&q=80'),
    ('Nuclear Explosion', 'Man-made or Hybrid', 'Three factors for protecting yourself from radiation and fallout are distance, shielding and time. (Taken from redcross.org)', 'https://images.unsplash.com/photo-1573487482166-09cd477f7b3b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1762&q=80'),
    ('Lost-at-Sea', 'Bonus', 'Wrestling with savage seas? Stranded without fuel or water? Return to shore in one piece with these seven sure-fire survival tips. (Taken from cnn.com)', 'https://cdn.cnn.com/cnnnext/dam/assets/130327105557-survival-guide-boat-horizontal-large-gallery.jpg');
...
INSERT INTO acclimate_user (user_name, user_password)
VALUES
    ('Minh', '$2a$04$D6GBjXwWpnDUL1jVafLOnuur9qX4BxY2Cn1xNqCyOr.dN7W1v7UAm'),
    ('Nick', '$2a$04$zG8fajgnjA82LoLCrFBSZueDa1nfz5iFb4Vk6I.FDiZplO3526J/y'),
    ('Wesley', '$2a$04$QhuicNhYjZLXXYn2RIN9FetYXdQd4pz/Dt/fR8jzyH57.L35Xz92a'),
    ('MattR', '$2a$04$AxnYuuO6JLP20/DUAoJHt.sGhnEzsM5JkanWkhutOVF4GmVT7a3Nu'),
    ('Muhajir', '$2a$04$hB4CE0MozX.YaJUyv6N5EempgaG0ZurwoKPJQinXk0bnbqYlGzPOi'),
    ('Ronnie', '$2a$04$KjyPssM/s332RVQD6/Kx/ez5AQqolYlK.UT2z8WWracdgsEwNbcr2');
